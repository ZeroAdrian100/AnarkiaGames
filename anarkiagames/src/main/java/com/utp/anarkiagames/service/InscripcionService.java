...
import com.utp.anarkiagames.controller.IncripcionRequest;
...
public class InscripcionService {
    ...
    public InscripcionResponse comprar(final long torneoId, final IncripcionRequest request, final User usuario){
